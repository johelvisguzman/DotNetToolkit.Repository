namespace DotNetToolkit.Repository.Integration.Test
{
    ...
    public class ServiceTraitsTests : TestBase
    {
        ...
        {
            ForAllUnitOfWorkFactories(TestExecuteQuery);
        }

        [Fact]
        public void ExecuteQueryAsync()
        {
            ForAllUnitOfWorkFactoriesAsync(TestExecuteQueryAsync);
        }
        ...
        private static void TestExecuteQuery(IUnitOfWorkFactory uowFactory)
        {
            const int id = 1;
            ...
            // ** CREATE **
            var rowsAffected = service.ExecuteQuery(@"
CREATE TABLE NewCustomers (
    ...
    AddressId int
            ...
            // ** INSERT **
            rowsAffected = service.ExecuteQuery(@"
...
VALUES (@p0, 'Random Name')",
            ...
            var customersInDb = service.ExecuteQuery(@"
SELECT
    NewCustomers.Id,
    NewCustomers.Name,
...
WHERE Id = @p0",
            ...
            customersInDb = service.ExecuteQuery(@"
SELECT
    NewCustomers.Id,
    NewCustomers.Name,
    NewCustomers.AddressId
...
WHERE NewCustomers.Id = @p0",
        ...
        private static async Task TestExecuteQueryAsync(IUnitOfWorkFactory uowFactory)
        {
            const int id = 1;
            ...
            // ** CREATE **
            var rowsAffected = await service.ExecuteQueryAsync(@"
CREATE TABLE NewCustomers (
    Id int,
    Name nvarchar(255),
    AddressId int
            ...
            // ** INSERT **
            rowsAffected = await service.ExecuteQueryAsync(@"
INSERT INTO NewCustomers (Id, Name)
VALUES (@p0, 'Random Name')",
                parameters);
            ...
            var customersInDb = await service.ExecuteQueryAsync(@"
SELECT
    NewCustomers.Id,
    NewCustomers.Name,
    NewCustomers.AddressId
...
WHERE Id = @p0",
            ...
            customersInDb = await service.ExecuteQueryAsync(@"
SELECT
    NewCustomers.Id,
    NewCustomers.Name,
    NewCustomers.AddressId
