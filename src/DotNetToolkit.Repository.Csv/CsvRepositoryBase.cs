namespace DotNetToolkit.Repository.Csv
{
    ...
    /// </summary>
    public abstract class CsvRepositoryBase<TEntity, TKey1, TKey2, TKey3> : InMemoryRepositoryFileBase<TEntity, TKey1, TKey2, TKey3> where TEntity : class
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="CsvRepositoryBase{TEntity, TKey1, TKey2, TKey3}"/> class.
        /// </summary>
    ...
    /// Represents a repository for storing entities as an csv formatted file with a composite primary key.
    /// </summary>
    public abstract class CsvRepositoryBase<TEntity, TKey1, TKey2> : InMemoryRepositoryFileBase<TEntity, TKey1, TKey2> where TEntity : class
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="CsvRepositoryBase{TEntity, TKey1, TKey2}"/> class.
        /// </summary>
        /// <param name="path">The database directory to create.</param>
        protected CsvRepositoryBase(string path) : base(path) { }
