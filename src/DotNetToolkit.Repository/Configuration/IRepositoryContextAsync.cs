namespace DotNetToolkit.Repository.Configuration
{
    ...
    public interface IRepositoryContextAsync : IRepositoryContext, IDisposable
    {
        ...
        Task<IQueryResult<IEnumerable<TEntity>>> ExecuteSqlQueryAsync<TEntity>(string sql, CommandType cmdType, object[] parameters, Func<IDataReader, TEntity> projector, CancellationToken cancellationToken = new CancellationToken()) where TEntity : class;
        ...
        Task<IQueryResult<int>> ExecuteSqlCommandAsync(string sql, CommandType cmdType, object[] parameters, CancellationToken cancellationToken = new CancellationToken());
