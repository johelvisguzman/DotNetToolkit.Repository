namespace DotNetToolkit.Repository
{
    ...
    public interface IRepository<TEntity, in TKey1, in TKey2, in TKey3> : IRepositoryBase<TEntity> where TEntity : class
    {
        /// <summary>
    ...
    /// <seealso cref="DotNetToolkit.Repository.IRepositoryBase{TEntity}" />
    /// <seealso cref="System.IDisposable" />
    public interface IRepository<TEntity, in TKey1, in TKey2> : IRepositoryBase<TEntity> where TEntity : class
    {
        /// <summary>
        /// Determines whether the repository contains an entity with the given composite primary key values.
        /// </summary>
    ...
    /// <seealso cref="DotNetToolkit.Repository.IRepositoryBase{TEntity}" />
    /// <seealso cref="System.IDisposable" />
    public interface IRepository<TEntity, in TKey> : IRepositoryBase<TEntity> where TEntity : class
    {
        /// <summary>
