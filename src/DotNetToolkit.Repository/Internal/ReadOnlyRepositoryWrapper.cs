namespace DotNetToolkit.Repository.Internal
{
    ...
    internal class ReadOnlyRepositoryWrapper<TEntity, TKey1, TKey2, TKey3> : IReadOnlyRepository<TEntity, TKey1, TKey2, TKey3> where TEntity : class
    {
        ...
        public PagedQueryResult<IEnumerable<TResult>> GroupBy<TGroupKey, TResult>(IQueryOptions<TEntity> options, Expression<Func<TEntity, TGroupKey>> keySelector, Expression<Func<IGrouping<TGroupKey, TEntity>, TResult>> resultSelector)
        {
        ...
        public Task<TEntity> FindAsync(TKey1 key1, TKey2 key2, TKey3 key3, string[] paths, CancellationToken cancellationToken)
        {
        ...
        public Task<TEntity> FindAsync(TKey1 key1, TKey2 key2, TKey3 key3, Expression<Func<TEntity, object>>[] paths, CancellationToken cancellationToken)
        {
            return _underlyingRepo.FindAsync(key1, key2, key3, paths, cancellationToken);
        }
        ...
        public Task<PagedQueryResult<IEnumerable<TResult>>> GroupByAsync<TGroupKey, TResult>(IQueryOptions<TEntity> options, Expression<Func<TEntity, TGroupKey>> keySelector, Expression<Func<IGrouping<TGroupKey, TEntity>, TResult>> resultSelector, CancellationToken cancellationToken = new CancellationToken())
        {
    ...
    internal class ReadOnlyRepositoryWrapper<TEntity, TKey1, TKey2> : IReadOnlyRepository<TEntity, TKey1, TKey2> where TEntity : class
    {
        ...
        public Task<TEntity> FindAsync(TKey1 key1, TKey2 key2, string[] paths, CancellationToken cancellationToken)
        {
        ...
        public Task<TEntity> FindAsync(TKey1 key1, TKey2 key2, Expression<Func<TEntity, object>>[] paths, CancellationToken cancellationToken)
        {
            return _underlyingRepo.FindAsync(key1, key2, paths, cancellationToken);
        }
    ...
    internal class ReadOnlyRepositoryWrapper<TEntity, TKey> : IReadOnlyRepository<TEntity, TKey> where TEntity : class
    {
        ...
        public Task<TEntity> FindAsync(TKey key, string[] paths, CancellationToken cancellationToken)
        {
        ...
        public Task<TEntity> FindAsync(TKey key, Expression<Func<TEntity, object>>[] paths, CancellationToken cancellationToken)
        {
            return _underlyingRepo.FindAsync(key, paths, cancellationToken);
        }
