namespace DotNetToolkit.Repository.Json
{
    ...
    /// </summary>
    public abstract class JsonRepositoryBase<TEntity, TKey1, TKey2, TKey3> : InMemoryRepositoryFileBase<TEntity, TKey1, TKey2, TKey3> where TEntity : class
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="JsonRepositoryBase{TEntity, TKey1, TKey2, TKey3}"/> class.
        /// </summary>
        ...
        #region Overrides of InMemoryRepositoryFileBase<TEntity, TKey1, TKey2, TKey3>
    ...
    /// Represents a repository for storing entities as an json formatted file with a composite primary key.
    /// </summary>
    public abstract class JsonRepositoryBase<TEntity, TKey1, TKey2> : InMemoryRepositoryFileBase<TEntity, TKey1, TKey2> where TEntity : class
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="JsonRepositoryBase{TEntity, TKey1, TKey2}"/> class.
        /// </summary>
        /// <param name="path">The database directory to create.</param>
        protected JsonRepositoryBase(string path) : base(path) { }
        ...
        #region Overrides of InMemoryRepositoryFileBase<TEntity, TKey1, TKey2>
