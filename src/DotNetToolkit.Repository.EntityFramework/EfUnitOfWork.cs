namespace DotNetToolkit.Repository.EntityFramework
{
    ...
    public class EfUnitOfWork : UnitOfWorkBaseAsync
    {
        ...
        public EfUnitOfWork(DbContext context) : base(new EfTransactionManager(context), new EfRepositoryFactory(() => context)) { }
        ...
        public EfUnitOfWork(DbContext context, IEnumerable<IRepositoryInterceptor> interceptors) : base(new EfTransactionManager(context), new EfRepositoryFactory(() => context, interceptors)) { }
