namespace DotNetToolkit.Repository.EntityFramework
{
    ...
    /// </summary>
    public abstract class EfRepositoryBase<TEntity, TKey1, TKey2, TKey3> : RepositoryBaseAsync<TEntity, TKey1, TKey2, TKey3> where TEntity : class
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EfRepositoryBase{TEntity, TKey1, TKey2, TKey3}" /> class.
        /// </summary>
    ...
    /// Represents a repository for entity framework with a composite primary key.
    /// </summary>
    public abstract class EfRepositoryBase<TEntity, TKey1, TKey2> : RepositoryBaseAsync<TEntity, TKey1, TKey2> where TEntity : class
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EfRepositoryBase{TEntity, TKey1, TKey2}" /> class.
        /// </summary>
        /// <param name="context">The database context.</param>
        protected EfRepositoryBase(DbContext context) : this(context, (IEnumerable<IRepositoryInterceptor>)null) { }
