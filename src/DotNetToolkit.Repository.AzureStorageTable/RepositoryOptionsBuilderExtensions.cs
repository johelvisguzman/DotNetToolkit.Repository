namespace DotNetToolkit.Repository.AzureStorageTable
{
    ...
    public static class RepositoryOptionsBuilderExtensions
    {
        ...
        public static RepositoryOptionsBuilder UseAzureStorageTable([NotNull] this RepositoryOptionsBuilder source, string nameOrConnectionString, bool createIfNotExists = false)
        {
        ...
        /// <param name="createIfNotExists">Creates the container if it does not exist.</param>
        /// <returns>The same builder instance.</returns>
        public static RepositoryOptionsBuilder UseAzureStorageTable([NotNull] this RepositoryOptionsBuilder source, string nameOrConnectionString, string tableName, bool createIfNotExists = false)
        {
            Guard.NotNull(source, nameof(source));
            Guard.NotEmpty(nameOrConnectionString, nameof(nameOrConnectionString));
