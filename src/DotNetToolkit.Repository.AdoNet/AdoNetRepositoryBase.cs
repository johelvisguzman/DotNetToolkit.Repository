namespace DotNetToolkit.Repository.AdoNet
{
    ...
    /// </summary>
    public abstract class AdoNetRepositoryBase<TEntity, TKey1, TKey2, TKey3> : RepositoryBaseAsync<TEntity, TKey1, TKey2, TKey3> where TEntity : class
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdoNetRepositoryBase{TEntity, TKey1, TKey2, TKey3}"/> class.
        /// </summary>
    ...
    /// Represents a repository for ado.net with a composite primary key.
    /// </summary>
    public abstract class AdoNetRepositoryBase<TEntity, TKey1, TKey2> : RepositoryBaseAsync<TEntity, TKey1, TKey2> where TEntity : class
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdoNetRepositoryBase{TEntity, TKey1, TKey2}"/> class.
        /// </summary>
        /// <param name="context">The context.</param>
        protected AdoNetRepositoryBase(AdoNetContext context) : this(context, (IEnumerable<IRepositoryInterceptor>)null) { }
