namespace DotNetToolkit.Repository.AdoNet
{
    ...
    public class AdoNetUnitOfWork : UnitOfWorkBaseAsync
    {
        ...
        public AdoNetUnitOfWork(string connectionString, IEnumerable<IRepositoryInterceptor> interceptors = null) : base(new AdoNetTransactionManager(connectionString))
        {
        ...
        /// <param name="connectionString">The connection string.</param>
        /// <param name="interceptors">The interceptors.</param>
        public AdoNetUnitOfWork(string providerName, string connectionString, IEnumerable<IRepositoryInterceptor> interceptors = null) : base(new AdoNetTransactionManager(providerName, connectionString))
        {
            Factory = new AdoNetRepositoryFactory(((AdoNetTransactionManager)TransactionManager).Transaction, interceptors);
        }
