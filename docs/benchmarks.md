...
The benchmark can be found in [DotNetToolkit.Repository.Performance](https://github.com/johelvisguzman/DotNetToolkit.Repository/tree/master/benchmarks/DotNetToolkit.Repository.Performance) and can be compiled via:
```
